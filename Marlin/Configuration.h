...
#define STRING_CONFIG_H_AUTHOR "Gelidus Inc" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "GR1"
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_Y_POINT 50 //Y_CENTER  // Y point for Z homing
#endif
